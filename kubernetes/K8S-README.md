...
```
$ docker image tag myapp registry.pvcb.vn/pvcombank/myapp
$ docker push registry.pvcb.vn/pvcombank/myapp
$ docker image tag myapp1 registry.pvcb.vn/pvcombank/myapp1
$ docker push registry.pvcb.vn/pvcombank/myapp1
$ docker image tag myapp2 registry.pvcb.vn/pvcombank/myapp2
$ docker push registry.pvcb.vn/pvcombank/myapp2
```
...
$ kubectl scale deployment <app-name> --replicas <replica-count> -n jhipster-project
...
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image> -n jhipster-project
...
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n jhipster-project
...
$ kubectl get svc exposed-registry -n jhipster-project
...
$ kubectl scale statefulset jhipster-registry --replicas 3 -n jhipster-project
