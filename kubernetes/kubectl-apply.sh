...
default() {
    ...
    kubectl label namespace jhipster-project istio-injection=enabled --overwrite=true
    kubectl apply -f myapp-${suffix}/
    kubectl apply -f myapp1-${suffix}/
    kubectl apply -f myapp2-${suffix}/
