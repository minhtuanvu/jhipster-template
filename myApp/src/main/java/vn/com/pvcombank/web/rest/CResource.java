...
import vn.com.pvcombank.repository.CRepository;
import vn.com.pvcombank.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.com.pvcombank.domain.C}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CResource {
    ...
    private static final String ENTITY_NAME = "myAppC";
